...
Public Class frmBestSoma
    ...
    Private Function BestSum(ByVal numeroAlvo As Integer, listaNumeros As List(Of Integer)) As List(Of Integer)
        ...
        If dicionarioSomas.ContainsKey(numeroAlvo) Then
            Dim combinacao As List(Of Integer) = dicionarioSomas(numeroAlvo)
            If ExisteCombinacao(combinacao) Then
                Return dicionarioSomas(numeroAlvo)
            End If
        End If
        ...
        If dicionarioSomas.ContainsKey(numeroAlvo) Then
            dicionarioSomas.Remove(numeroAlvo)
        End If
        dicionarioSomas.Add(numeroAlvo, menorCombinacao)
